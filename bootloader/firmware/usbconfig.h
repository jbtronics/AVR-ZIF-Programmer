 ...
 */
#define USB_CFG_VENDOR_NAME 'J','B','t','r','o','n','i','c','s',' ','j','b','t','r','o','n','i','c','s','w','o','r','d','p','r','e','s','s','.','c','o','m'
 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME 'A', 'V', 'R', '-', 'Z', 'I', 'F', '-','P','R','O','G',' ','B','O','O','T','L','O','A','D','E','R'
